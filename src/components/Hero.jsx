...
function Hero() {
    return (
        <section className="text-center mt-14 md:mt-4">
            ...
            <div className="bg-d-green text-white p-4 flex flex-col md:flex-row md:flex-row-reverse md:justify-between">
                <div className="md:mr-[15vw]">
                    {/* Titulo principal */}
                    <div className="md:pt-[5vw] md:mb-10">
                        <h1 className='font-bold text-[24px] md:text-[40px]'>Atendimento de <br />
                    ...
                    {/* Região */}
                    <div className="border border-l-green rounded-full text-[14px] font-bold m-4 relative flex items-center p-3 py-4 md:py-6">
                        <img src={local} alt="Icone Local" className="ml-2 md:w-[26px] md:ml-9"></img>
                        <p className="absolute left-1/2 -translate-x-1/2 text-center text-[15px] w-[261px] md:text-[24px] md:w-[326px]">Em curitiba e Região <br /> Metropolitana</p>
                    </div>
                    {/* Região */}
                ...
                {/* Imagem */}
                <div className="relative z-10 -mx-4 md:-ml-20 md:mr-0 md:p-0">
