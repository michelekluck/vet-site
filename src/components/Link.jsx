...
function Link({ variant = "zap", children, className = "", href = "", ...props }) {
    ...
    return (
        <a target="_blank" rel="noopener noreferrer" href={href} className={`rounded-full bg-l-green text-d-green font-bold relative flex items-center w-[340px] h-[52px] py-8 lg:py-10 lg:w-[490px] lg:mt-4 ${className}`}{...props}>
