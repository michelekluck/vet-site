    ...
    return (
        <section className="bg-d-green mt-9">
            <div className="text-white p-4">
                ...
                <p className="text-[14px] leading-7 mb-6">Também realizo <span className="font-bold">atendimentos na Universidade Tuiuti do Paraná</span> como aprimorando da área de Clínica e Cirurgia de Pets Não Convencionais e Animais Silvestres. <br />
